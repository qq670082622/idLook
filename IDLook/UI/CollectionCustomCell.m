...
@interface CollectionCustomCell ()
...
-(UIButton*)collectionBtn
{
    if (!_collectionBtn) {
        ...
        [_collectionBtn setBackgroundImage:[UIImage imageNamed:@"collect_pur_n"] forState:UIControlStateNormal];
        [_collectionBtn setBackgroundImage:[UIImage imageNamed:@"collect_pur_h"] forState:UIControlStateSelected];
...
-(void)addCollection
{
    self.CollectionAction(!self.collectionBtn.selected);
}
