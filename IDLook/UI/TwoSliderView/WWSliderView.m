...
- (void)setLayerFrames
{
    ...
    trackLayer.frame = CGRectMake(track_x, self.frame.size.height * 0.5 - 1, self.frame.size.width - track_x * 2, 4);
 ...
 //   NSString *rightStr = (NSInteger)_upperValue < 10 ? @"0" : @"";
  ...
  //  rightLabel.text = [NSString stringWithFormat:@"%@%ld:00",rightStr,(NSInteger)_upperValue];
      leftLabel.text = [NSString stringWithFormat:@"%ld%@",(NSInteger)_lowerValue,_type];
      rightLabel.text = [NSString stringWithFormat:@"%ld%@",(NSInteger)_upperValue,_type];
    //判断两个label没有重叠
