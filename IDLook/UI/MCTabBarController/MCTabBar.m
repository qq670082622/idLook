...
- (void)layoutSubviews {
    ...
    switch (self.position) {
        ...
        case MCTabBarCenterButtonPositionBulge:
             _centerBtn.frame = CGRectMake(([UIScreen mainScreen].bounds.size.width - _centerWidth)/2.0, -_centerHeight/3.0 + self.centerOffsetY, _centerWidth, _centerHeight);//y值2改为3 让图片稍微往下了
            break;
        default:
            break;
    }
