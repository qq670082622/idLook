...
- (void)configBottomToolBar {
    ...
    [_doneButton setTitle:[NSString stringWithFormat:@"%@(%zd/%ld)",tzImagePickerVc.doneBtnTitleStr,tzImagePickerVc.selectedModels.count,tzImagePickerVc.maxImagesCount] forState:UIControlStateNormal];
    [_doneButton setTitle:[NSString stringWithFormat:@"%@(%zd/%ld)",tzImagePickerVc.doneBtnTitleStr,tzImagePickerVc.selectedModels.count,tzImagePickerVc.maxImagesCount] forState:UIControlStateDisabled];
    ...
    _doneButton.backgroundColor=[UIColor colorWithRed:255/255.0 green:74/255.0 blue:87/255.0 alpha:1.0];
...
- (void)viewDidLayoutSubviews {
    ...
    _doneButton.frame = CGRectMake(self.view.tz_width - 84 - 15, 9, 84, 32);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.didSelectPhotoBlock = ^(BOOL isSelected) {
        ...
        __strong __typeof(weakLayer) strongLayer = weakLayer;
