...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_tzImagePickerVc.allowPickingMultipleVideo && model.type == TZAssetModelMediaTypeVideo) {
        ...
        __weak __typeof(_tzImagePickerVc) weakTzImagePickerVc = _tzImagePickerVc;
        __weak __typeof(_collectionView) weakCollectionView = _collectionView;
        __weak __typeof(photoPreviewCell) weakCell = photoPreviewCell;
        [photoPreviewCell setImageProgressUpdateBlock:^(double progress) {
            __strong __typeof(weakSelf) strongSelf = weakSelf;
            __strong __typeof(weakTzImagePickerVc) strongTzImagePickerVc = weakTzImagePickerVc;
