...
- ( NSMutableDictionary *)sendPay_demo:(NSString *)desc :(int)price :(NSString *) tradeNo
{
    ...
    //订单标题，展示给用户
    NSString *order_name    = desc;
    //订单金额,单位（分）
    NSString *order_price   = [NSString stringWithFormat:@"%d", price*100];
    ...
    [packageParams setObject: @"192.168.2.3"    forKey:@"spbill_create_ip"];//发器支付的机器ip
