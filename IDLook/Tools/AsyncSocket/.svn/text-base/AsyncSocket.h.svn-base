...
// Once one of the accept or connect methods are called, the AsyncSocket userDefault is locked in
 ...
 * When a connection comes in, the AsyncSocket userDefault will call the various delegate methods (see above).
 ...
 * 
 * Please note the recommended way of releasing an AsyncSocket userDefault (e.g. in a dealloc method)
...
/**
 * Returns the current run loop modes the AsyncSocket userDefault is operating in.
 * The default set of run loop modes is NSDefaultRunLoopMode.
**/
